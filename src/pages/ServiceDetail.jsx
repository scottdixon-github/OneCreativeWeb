...
export default function ServiceDetail() {
  ...
  const canonical = `https://www.onecreativeweb.com/services/${slug}`
  ...
  return (
    <div className="noise-bg pt-36">
      <SEO
        ...
        keywords={`${service.title}, ${service.technologies.join(', ')}, Charleston web development, One Creative Web`}
        canonical={canonical}
        jsonLd={{
