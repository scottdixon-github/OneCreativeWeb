...
export default function Home() {
  ...
  return (
    <div className="noise-bg">
      <SEO
        title="Charleston Web Development Agency"
        description="One Creative Web .com is a Charleston, SC web development agency. We build custom websites, web apps, e-commerce stores, and UI/UX designs that rank, convert, and scale."
        keywords="One Creative Web .com, web development Charleston SC, custom websites, web apps, e-commerce, UI/UX design, SEO, web design agency"
        canonical="https://www.onecreativeweb.com/"
        jsonLd={{
          ...
          '@graph': [
            {
              ...
              description:
                'One Creative Web .com is a Charleston, SC web development agency. We build custom websites, web apps, e-commerce stores, and UI/UX designs that rank, convert, and scale.',
              publisher: {
                '@type': 'Organization',
                name: 'One Creative Web .com',
                url: 'https://www.onecreativeweb.com/',
            ...
            },
            {
              ...
              description:
                'One Creative Web .com is a Charleston, SC web development agency. We build custom websites, web apps, e-commerce stores, and UI/UX designs that rank, convert, and scale.',
              url: 'https://www.onecreativeweb.com/',
              telephone: '+1-312-956-7549',
              email: 'hello@onecreativeweb.com',
              priceRange: '$$$',
              address: {
                '@type': 'PostalAddress',
              ...
              hasMap:
                'https://www.google.com/maps/search/?api=1&query=Charleston,SC',
              areaServed: {
                '@type': 'Place',
        ...
        <div className="relative min-h-[calc(100svh-14rem)] flex items-center">
          ...
          >
            ...
            <p className="mx-auto mt-8 max-w-2xl text-lg font-medium leading-relaxed text-content-muted text-pretty">
              One Creative Web .com delivers custom websites, web applications, and e-commerce
