  ...
  return (
    <div className="noise-bg pt-36">
      <SEO
        ...
        description="See custom websites, web applications, e-commerce stores, and UI/UX design projects built by One Creative Web .com in Charleston, SC."
        keywords="web design portfolio, web development portfolio, Charleston, custom websites, e-commerce, web apps, UI/UX design"
        canonical="https://www.onecreativeweb.com/portfolio"
        jsonLd={{
          '@context': 'https://schema.org',
          '@type': 'CollectionPage',
          name: 'Web Design & Development Portfolio',
          url: 'https://www.onecreativeweb.com/portfolio',
          description:
            'See custom websites, web applications, e-commerce stores, and UI/UX design projects built by One Creative Web .com in Charleston, SC.',
          mainEntity: {
            '@type': 'ItemList',
