  ...
  return (
    <div className="noise-bg pt-36">
      <SEO
        ...
        description="Explore our full range of web development services in Charleston, SC — custom websites, e-commerce, web apps, UI/UX design, responsive mobile design, and SEO."
        keywords="web development services, custom websites Charleston, e-commerce solutions, web application development, UI/UX design, responsive design, SEO services"
        canonical="https://www.onecreativeweb.com/services"
        jsonLd={{
          '@context': 'https://schema.org',
          '@type': 'CollectionPage',
          name: 'Web Development Services',
          url: 'https://www.onecreativeweb.com/services',
          description:
            'Explore our full range of web development services in Charleston, SC — custom websites, e-commerce, web apps, UI/UX design, responsive mobile design, and SEO.',
          mainEntity: {
            '@type': 'ItemList',
            itemListElement: services.map((s, i) => ({
              '@type': 'ListItem',
              position: i + 1,
              url: `https://www.onecreativeweb.com/services/${s.slug}`,
              name: s.title,
            })),
          },
        }}
