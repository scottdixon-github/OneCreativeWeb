...
VERSION:3.0
FN:One Creative Web .com
ORG:One Creative Web .com
...
END:VCARD`
  ...
  link.href = url
  link.setAttribute('download', 'One_Creative_Web.vcf')
...
export default function Contact() {
  ...
  return (
    <div className="noise-bg pt-36">
      <SEO
        title="Contact Us"
        description="Get a free consultation and quote from One Creative Web .com. Contact our Charleston, SC web development team for custom websites, web apps, and e-commerce."
        keywords="contact One Creative Web, web development quote, Charleston web agency, free consultation, custom website quote"
        canonical="https://www.onecreativeweb.com/contact"
        jsonLd={{
          '@context': 'https://schema.org',
          '@type': 'ContactPage',
          name: 'Contact One Creative Web .com',
          url: 'https://www.onecreativeweb.com/contact',
          description:
            'Get a free consultation and quote from One Creative Web .com. Contact our Charleston, SC web development team for custom websites, web apps, and e-commerce.',
          mainEntity: {
            '@type': 'LocalBusiness',
