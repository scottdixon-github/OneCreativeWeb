      ...
      <div className="container-max relative px-4 py-16 sm:px-6 lg:px-8">
          ...
          <div className="lg:col-span-1">
            <Link to="/" className="flex items-center gap-2.5">
              ...
              <span className="font-display text-xl font-bold text-content">
                One Creative <span className="gradient-text">Web</span> <span className="text-sm font-semibold text-brand">.com</span>
              </span>
            </Link>
        ...
        <div className="mt-12 flex flex-col items-center justify-between gap-4 border-t border-line pt-8 sm:flex-row">
          <p className="text-sm font-medium text-content-muted">
            © {year} One Creative Web .com. All rights reserved.
          </p>
